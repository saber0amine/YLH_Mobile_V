    ...
    CheckUserLogin() ;
        ...
        private void CheckUserLogin() {
            ...
            if(email.isEmpty() || password.isEmpty()) {
                loginErrors.setText("Email and Password cannot be empty.");
                return;
            }
            User user = new User();
            user.setEmail(email);
            ...
            userLiveData.observe(this, jwt -> {
                if (jwt != null && jwt.startsWith("ok")) {
                    ...
                    loginErrors.setText(jwt != null ? jwt : "Login failed. Please try again.");
                }
            });
        }
            ...
            if (user != null) {
                ...
                userName.observe(this, user1 -> {
                    if (user1 != null) {
                        ...
                        Log.e("storeUserInformation", "User retrieval failed.");
                    }
                });
            }
        }
